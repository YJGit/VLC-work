...
/**
 * Created by yjing on 2017/11/18.
 * reference http://www.voidcn.com/article/p-mrguekyd-nq.html
 */
...
public class PcmToWavUtil {
    ...
    * @param outFilename 目标文件路径
     */
    public int pcmToWav(String inFielname, String outFilename) {
        FileInputStream in;
        ...
        try {
            in = new FileInputStream(inFielname);
